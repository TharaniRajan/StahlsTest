...
export class TicketdetailsComponent implements OnInit {
  ...
  loadDataPage() {
    ...
    // console.log('########sortLabel###### ---- ', sortLabel, sortDirection);
  ...
  sendMessage() {
    ...
    this.ticketDetailService.getTicketByUuid(this.ticketDetails.uuid).subscribe(
      data => {
        ...
        // console.log('total emails are --assigned user--- ', sendAssignedDetails.emailDetails);
        ...
        // console.log('after removing total emails are ---assigned user-- ', sendAssignedDetails.emailDetails);
    ...
    this.attachmenturl.forEach(element => {
      ...
      this.ticketDetailService.DeleteAttachementbyid(element.uuid).subscribe(data => {
        ...
        if (count === this.attachmenturl.length) {
          ...
          //   sendDeleteDetails.createdUserEmail = this.ticketDetails.created_by.email;
          // }
          if (this.ticketDetails.created_by != null) {
          ...
          // console.log('total emails are --delete attachments--- ', sendDeleteDetails.emailDetails);
          ...
          // console.log('after removing total emails are - delete attachments---- ', sendDeleteDetails.emailDetails);
  ...
  fileupload() {
    ...
    this.ticketDetailService.update_Ticket(dataToUpdate).subscribe(data => {
      ...
      //   });
      // }
      //   console.log('total emails are --file upload--- ', sendDetails.emailDetails);
      //   sendDetails.emailDetails.splice(sendDetails.emailDetails.indexOf(this.currentUserEmail), 1);
      //   console.log('after removing total emails are - file upload---- ', sendDetails.emailDetails);
      ...
      // console.log('total emails are ----- ', sendDetails.emailDetails);
      if (sendDetails.emailDetails.indexOf(this.currentUserEmail) > -1) {
        sendDetails.emailDetails.splice(sendDetails.emailDetails.indexOf(this.currentUserEmail), 1);
      }
      // console.log('after removing total emails are ----- ', sendDetails.emailDetails);
  ...
  closeTicketOption() {
    ...
    this.ticketDetailService.update_Ticket(dataToUpdate).subscribe(
      data => {
        ...
        //   // }
        //   dataToUpdate.currentUser = this.Username;
        //   dataToUpdate.emailDetails.push(this.ticketDetails.created_by.email);
        // }
        ...
        // if (this.ticketDetails.assigned_to.length > 0) {
        //   this.ticketDetails.assigned_to.forEach(element => {
        //     dataToUpdate.emailDetails.push(element.email);
        //   });
        // }
        // console.log('total emails are -close tickets---- ', dataToUpdate.emailDetails);
        // dataToUpdate.emailDetails.splice(dataToUpdate.emailDetails.indexOf(this.currentUserEmail), 1);
        // console.log('after removing total emails are - close tickets---- ', dataToUpdate.emailDetails);
        const sendDetails = {
          Status: 'Closed',
          comments: '',
          userId: this.Useruuid,
  ...
  Reopenticket() {
    ...
    this.ticketDetailService.Reopen_ticket(dataToUpdate).subscribe(
      data => {
        ...
        // if (this.ticketDetails.created_by != null) {
        //   dataToUpdate.currentUser = this.Username;
        //   dataToUpdate.email.push(this.ticketDetails.created_by.email);
        // }
        // // this.ticketDetails.assigned_to.forEach(element => {
        // //   dataToUpdate.email.push(element.email);
        // // });
        // // if (this.ticketDetails.created_by != null) {
        // //   sendCommentDetails.emailDetails.push(this.ticketDetails.created_by.email);
        // // }
        ...
        //   });
        // }
        // console.log('total emails are -reopen tickets---- ', dataToUpdate.emailDetails);
        // dataToUpdate.emailDetails.splice(dataToUpdate.emailDetails.indexOf(this.currentUserEmail), 1);
        // console.log('after removing total emails are - reopen tickets---- ', dataToUpdate.emailDetails);
        ...
        // console.log('total emails are -reopen---- ', sendReopenDetails.emailDetails, this.currentUserEmail,
        // sendReopenDetails.emailDetails.indexOf(this.currentUserEmail));
        ...
        // console.log('after removing total emails are -reopen---- ', sendReopenDetails.emailDetails);
  ...
  closecomment() {
    ...
    console.log('total emails are ----- ', sendCommentDetails.emailDetails);
    ...
    console.log('after removing total emails are ----- ', sendCommentDetails.emailDetails);
